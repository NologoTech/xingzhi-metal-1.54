...
## 简介
无名科技星智 1.54 METAL 是星智 1.54 开模版的升级款，配备 1.54 寸 LCD 屏幕与 CST816 触摸芯片。它用触摸交互替代物理按键，并将外壳升级为铝合金材质，同步优化了交互体验与产品质感、手感。
...
```bash
- `Xiaozhi Assistant` → `Board Type` → 选择 `无名科技星智1.54 METAL`
```
