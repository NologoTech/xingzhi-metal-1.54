...
/* Initialize the NimBLE host configuration. */
    ...
    sprintf(blu_mac, "Metal_AI-%02X%02X", sta_mac[4],sta_mac[5]);
    
    rc = ble_svc_gap_device_name_set(blu_mac);
    assert(rc == 0);
    ...
    err = esp_nimble_enable(reinterpret_cast<void*>(bleprph_host_task));
